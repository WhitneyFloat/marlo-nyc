        ...
        {sent ? (
          <div className="text-center animate-fade-in">
            ...
            <p className="text-stone font-body text-sm">
              Marlo sent a magic link to <span className="font-medium text-ink">{email}</span>.
          ...
          <>
            ...
            <form onSubmit={handleMagicLink} className="space-y-3">
              ...
              >
                {loading ? "Marlo's handling it..." : 'Send magic link'}
              </button>
            </form>

            <p className="text-center text-stone text-xs font-body mt-6">
              New to Marlo?{' '}
              <Link href="/signup" className="text-terracotta hover:text-terra-light">
                Create an account
              </Link>
            </p>
          </>
